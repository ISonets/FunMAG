#!/usr/bin/env python3
"""
Compute median coverage across samples for MetaBAT2 bins.
Usage: python median_cov_metabat.py depth.tsv metabat_bins_dir output.tsv
"""
...
def main():
    if len(sys.argv) != 4:
        print("Usage: median_cov_metabat.py <depth.tsv> <bins_dir> <output.tsv>", file=sys.stderr)
        sys.exit(1)
